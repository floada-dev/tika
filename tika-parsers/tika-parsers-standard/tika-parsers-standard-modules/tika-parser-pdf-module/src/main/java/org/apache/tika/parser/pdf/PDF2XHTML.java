...
class PDF2XHTML extends AbstractPDF2XHTML {
    ...
    public static void process(PDDocument document, ContentHandler handler, ParseContext context,
        ...
        try {
            ...
            if (handler instanceof ContentHandlerDecorator &&
                ...
                pdf2XHTML =
                        new PositionAwarePDF2XHTML(document, handler, ph, context, metadata, config,
                                renderer);
    ...
    private static class PositionAwarePDF2XHTML extends PDF2XHTML {
        ...
        protected void endPage(PDPage page) throws IOException {
            ...
            positionContentHandler.endPage(pageBox.getWidth(), pageBox.getHeight(), page.getRotation());
        }
